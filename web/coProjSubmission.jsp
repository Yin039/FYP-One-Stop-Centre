<%-- 
    Document   : coProjSubmission
    Created on : Jun 25, 2023, 6:37:36 PM
    Author     : TEOH YI YIN
--%>
            ...
            <div class="enroll-con d-flex justify-content-between align-items-center">
                <div class='row'>
                    ...
                    <div class="col-3 mt-2">
                        <select class="form-select lightBlue border-dark" name="status" onchange="window.location = 'coProjSubmission.jsp?courseName=' + this.value">
