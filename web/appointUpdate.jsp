<%-- 
    ...
    Created on : Apr 3, 2023, 10:26:52 PM
    Author     : TEOH YI YIN
--%>
...
<html>
    ...
    <%
        ...
        appointment appoint = appointmentDao.getAppointByID(appointID);
        meeting meet = meetingDao.getMeetByID(appoint.getMeetID());
    %>
    <body>
        ...
        <div class="container">
            ...
            <div class="form">
                <form action="MeetingServlet?action=UPDATEAPPOINT" class="row g-4 mt-3" method="post">
                    ...
                    <input type="hidden" name="meetID" value="<%=appoint.getMeetID()%>">
                    ...
                    <div class="row justify-content-center pt-2">
                        ...
                        <div class="col-1 mt-2 mb-5">
                            <a href="stuAppoint.jsp?status=Appointed" class="btn btn-primary float-end">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
